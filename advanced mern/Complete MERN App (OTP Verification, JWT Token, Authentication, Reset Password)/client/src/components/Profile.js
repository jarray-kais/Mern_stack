  ...
  return (
    <div className="container mx-auto">
      ...
      <div className='flex justify-center items-center h-screen'>
        <div className={`${styles.glass} ${extend.glass}`} style={{ width: "45%", paddingTop: '3em', height : "680px"}}>
          ...
          <form className='py-1' onSubmit={formik.handleSubmit}>
              ...
              <div className="name flex w-3/4 gap-10">
                  ...
                  <div className="name flex w-3/4 gap-10">
                  <input {...formik.getFieldProps('mobile')} className={styles.textbox} type="text" placeholder='mobile N' />
                  <input {...formik.getFieldProps('address')} className={styles.textbox} type="text" placeholder='adress ' />
                  </div>
                  <div className="name flex w-3/4 gap-10">
